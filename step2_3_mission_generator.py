...
3. Respect the defined ranges and categories.
   ...
   - For Strict Categories: YOU MUST USE ONLY THE EXACT VALUES LISTED IN "Available Variables" (e.g., if 'variable_name': 'A | B', then 'variable_name' == 'A' is valid, 'variable_name' == 'C' is INVALID).
